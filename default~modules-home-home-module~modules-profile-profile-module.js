(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~modules-home-home-module~modules-profile-profile-module"],{
...
/***/ "./src/app/shared/services/file-uploader.service.ts":
/*!**********************************************************!*\
  !*** ./src/app/shared/services/file-uploader.service.ts ***!
  \**********************************************************/
/*! exports provided: FileQueueStatus, FileQueueObject, FileUploaderService */
...
var FileUploaderService = /** @class */ (function () {
    function FileUploaderService(http) {
        this.http = http;
        this.singleUploadUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiRoot + '/files/upload';
        this.multipleUploadUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].apiRoot + '/files/multiple';
        this._files = [];
    ...
    FileUploaderService.prototype.addToQueue = function (data) {
        ...
        lodash__WEBPACK_IMPORTED_MODULE_1__["each"](data, function (file) { return _this._addToQueue(file); });
    };
    ...
    FileUploaderService.prototype.uploadAll = function () {
        ...
        lodash__WEBPACK_IMPORTED_MODULE_1__["each"](this._files, function (queueObj) {
            if (queueObj.isUploadable()) {
                _this._upload(queueObj);
            }
        });
    };
    FileUploaderService.prototype.uploadProfilePhoto = function (file, userId) {
        var _this = this;
        var form = new FormData();
        form.append('file', file, file.name);
        var profilePhotoUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].usersEndpoint + '/' + userId.toString() + '/profile_photo';
        console.log('Filename: ' + file.name + '\nprofilePhotoUrl: ' + profilePhotoUrl);
        var req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpRequest"]('POST', profilePhotoUrl, form);
        this.http.request(req).subscribe(function (event) {
            if (event instanceof _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpResponse"]) {
                _this.onCompleteItem(new FileQueueObject(event.body), event.body);
            }
        }, function (err) {
    ...
    FileUploaderService.prototype._removeFromQueue = function (queueObj) {
        lodash__WEBPACK_IMPORTED_MODULE_1__["remove"](this._files, queueObj);
    };
    FileUploaderService.prototype._upload = function (queueObj) {
        ...
        var req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpRequest"]('POST', this.singleUploadUrl, form, {
            reportProgress: true,
        });
        // upload file and report progress
    ...
    FileUploaderService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
//# sourceMappingURL=default~modules-home-home-module~modules-profile-profile-module.js.map