(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~main-main-module~modules-register-register-module"],{
...
/***/ "./src/app/shared/services/check.service.ts":
/*!**************************************************!*\
  !*** ./src/app/shared/services/check.service.ts ***!
  \**************************************************/
...
var CheckService = /** @class */ (function () {
    ...
    CheckService.prototype.checkEmailExists = function (email) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiRoot + '/check/exists/email/' + email);
    };
    CheckService.prototype.checkUsernameExists = function (username) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiRoot + '/check/exists/username/' + username);
    };
    CheckService.prototype.checkProviderApplicationStatus = function () {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiRoot + '/check/provider/');
    };
    CheckService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
/***/ "./src/app/shared/validators/email-taken.validator.ts":
/*!************************************************************!*\
  !*** ./src/app/shared/validators/email-taken.validator.ts ***!
  \************************************************************/
...
var ValidateEmailNotTaken = /** @class */ (function () {
    ...
    ValidateEmailNotTaken.createValidator = function (check) {
        return function (control) {
            return check.checkEmailExists(control.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (res) {
                console.log('res', res);
...
/***/ "./src/app/shared/validators/username-taken.validator.ts":
/*!***************************************************************!*\
  !*** ./src/app/shared/validators/username-taken.validator.ts ***!
  \***************************************************************/
/*! exports provided: ValidateUsernameNotTaken */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ValidateUsernameNotTaken", function() { return ValidateUsernameNotTaken; });
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");

var ValidateUsernameNotTaken = /** @class */ (function () {
    function ValidateUsernameNotTaken() {
    }
    ValidateUsernameNotTaken.createValidator = function (check) {
        return function (control) {
            return check.checkUsernameExists(control.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])(function (res) {
                console.log('res', res);
                return res.exists ? { usernameTaken: true } : null;
            }));
        };
    };
    return ValidateUsernameNotTaken;
}());
...
//# sourceMappingURL=default~main-main-module~modules-register-register-module.js.map